...
if (!class_exists(Spyc::class)) {
    ...
    class Spyc {
         ...
         * @access private
         * @return string
         * @param $array mixed The array you want to convert
         * @param $indent mixed The indent of the current level
         */
         ...
         * @access private
         * @return string
         * @param $value mixed The string you wish to fold
         */
         ...
         * @param $words mixed The words to translate
         * @access private
         */

...
resource "aws_ecs_task_definition" "wikijump_task" {
  ...
  container_definitions    = "[${module.cache.json_map_encoded},${module.database.sensitive_json_map_encoded},${module.php-fpm.sensitive_json_map_encoded},${module.nginx.sensitive_json_map_encoded},${module.reverse-proxy.sensitive_json_map_encoded},${module.datadog.sensitive_json_map_encoded},${module.api.sensitive_json_map_encoded}]"
